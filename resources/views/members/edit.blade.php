...
<div class="page-header">
    <h1><i class="bi bi-pencil-square me-2 text-danger"></i>Edit Member</h1>
            ...
            <div class="card-body p-4">
                <form action="{{ route('members.update', $member) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-lg me-1"></i>Update Member</button>
